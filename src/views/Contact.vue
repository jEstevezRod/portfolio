  ...
  <section class="h-screen w-full flex flex-col lg:mt-48 items-center">
    ...
    <div class="my-10">
      <p class="mx-4 text-2xl">
        ...
        <a
          href="mailto:jesestrod.business@gmail.com"
          class="text-red-400"
        >here.</a>
      </p>
    </div>
    ...
    <form class="w-5/6 max-w-lg mx-10" ref="contactForm" @submit.prevent="sendEmail">
      ...
      <div class="w-full mb-5" v-if="$v.name.$anyError">
        ...
        <p class="text-red-400 text-sm" v-if="!$v.name.minLength">
      ...
      <div class="w-full mb-5" v-if="$v.email.$anyError">
        ...
        <p class="text-red-400 text-sm" v-if="!$v.email.email">Is not a correct email format</p>
      </div>
      <div class="md:flex md:items-center mb-3">
        <div class="md:w-1/3 flex justify-start md:block">
          <label class="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4">Message</label>
        </div>
        <div class="md:w-2/3">
          <textarea
      ...
      <div class="w-full mb-5" v-if="$v.messageT.$anyError">
        ...
        <p class="text-red-400 text-sm" v-if="!$v.messageT.minLength">
          Your message must have at least
          {{$v.messageT.$params.minLength.min}} letters.
        </p>
      </div>
        ...
        emailjs
          ...
          .then(
            ...
            () => {
              this.$swal(
                `Ouch!`,
                "There are a problem sending the email. If you need to contact me you can do it through: jesestrod.business@gmail.com",
                "error"
              );
            }
          )
